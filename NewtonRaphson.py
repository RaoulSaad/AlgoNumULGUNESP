...
class TrigonometricFunction:
    ...
    def Calculate_TrigonometricFunction(self, point):
        ...
        for i in range(len(self.sin_coef)):
            ...
            value += self.sin_coef[i] * sin(self.sin_coef[i]*point)
    ...
    def Newton_Raphson_Trigo(self, X1, tries_nb, Epsilon):
        ...
        while (Precision > Epsilon):
            if derivative.Calculate_TrigonometricFunction(X1) != 0 and iter_nb < MAX_ITERATIONS:
                ...
                if tries_nb == 10:
                    ...
                    return self.Newton_Raphson_Trigo(uniform(-1000,1000), tries_nb+1, Epsilon)
        return X_next
...
class PolynomialFunction:
    ...
    def Newton_Raphson_Poly(self, X1, tries_nb,Epsilon):
            ...
            if derivative.Calculate_PolynomialFunction(X1) != 0 and iter_nb < MAX_ITERATIONS:
                ...
                if tries_nb == 10:
                    ...
                    if iter_nb >= MAX_ITERATIONS:
                        ...
                        print("Cannot apply the Newton-Raphson Method (Divison by zero).\n Trying a new starting point.")
                    return self.Newton_Raphson_Poly(uniform(-1000,1000), tries_nb+1, Epsilon)
...
class System():
    ...
    def Newton_Raphson_System(self, X1, tries, Epsilon):
        Precision = 1.
        while (Precision > Epsilon):
            if np.linalg.det(self.Jacobian_Matrix(X1)) != 0:
                ...
                if tries != 10:
                    ...
                    return self.Newton_Raphson_System([uniform(-1000,1000) for _ in range(self.Equation_Nb)], tries+1, Epsilon)
                else:
...
- user interface (terminal command)
"""